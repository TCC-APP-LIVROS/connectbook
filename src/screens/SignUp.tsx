import { VStack, Center, Text, Image, Heading, Container, ScrollView } from "native-base";
...
export function SignUp() {
  ...
  return (
    <VStack flex={1} px={10} borderBottomRadius={"12"} bg={"gray.200"}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <Center mt="12">
          ...
          <Button type="tertiary" w="full" mt="4" title={t("SignUp:Go-to-login")} mb="12" />
        </Center>
